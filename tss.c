...
void tss_inicializar() {
	uint tss_inicial=crear_tss(GDT_IDX_KDATA_DESC<<3, 0x2700, 0x27000, 0x16000, 0x2700, 0x2700,GDT_IDX_KCODE_DESC<<3,GDT_IDX_KDATA_DESC<<3,GDT_IDX_KDATA_DESC<<3);
	uint tss_idle   =crear_tss(GDT_IDX_KDATA_DESC<<3, 0x2700, 0x27000, 0x16000, 0x2700, 0x2700,GDT_IDX_KCODE_DESC<<3,GDT_IDX_KDATA_DESC<<3,GDT_IDX_KDATA_DESC<<3);
	//Magic number?
